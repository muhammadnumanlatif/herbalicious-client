...
interface ContactClientProps {
    pageData?: any; // WordPress content if available
}
        ...
        <div className="contact-page pt-5">
            <Container className="py-5">
                <div className="text-center mb-5 pb-4">
                    ...
                    {pageData?.content ? (
                        <div className="lead text-muted mx-auto" style={{ maxWidth: '700px' }} dangerouslySetInnerHTML={{ __html: pageData.content }} />
                    ) : (
                            ...
                            <Card.Body className="p-5">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <Row className="g-3">
                                        ...
                                        <Col xs={12}>
                                            <Button type="submit" size="lg" className="w-100 rounded-pill fw-bold py-3 mt-2" disabled={isSubmitting}>
